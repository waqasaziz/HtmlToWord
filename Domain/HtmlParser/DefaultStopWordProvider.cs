    ...
    public class DefaultStopWordProvider : IStopWordProvider
    {
        public string[] GetStopWords()
        {
            ...
            return new string[]
            {
                ...
                "himself", "his", "how", "how's", "http", "i", "i'd", "i'll", "i'm", "i've", "if", "in", "into", "is", "isn't", "it",
                ...
                "which", "while", "who", "who's", "whom", "why", "why's", "with", "won't", "would", "wouldn't", "wwww", "you", "you'd", "you'll",
                "you're", "you've", "your", "yours", "yourself", "yourselves","x","y","z"};
        }
    }
}
